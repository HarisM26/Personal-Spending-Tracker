# Generated by Django 4.1.5 on 2023-03-22 13:23
...
import expenditure.models.user
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('league_status', models.CharField(choices=[('bronze', 'bronze'), ('silver', 'silver'), ('gold', 'gold'), ('platinum', 'platinum'), ('diamond', 'diamond')], default='bronze', max_length=8)),
                ('is_staff', models.BooleanField(default=False)),
                ('is_active', models.BooleanField(default=True)),
                ('is_private', models.BooleanField(default=False)),
                ('toggle_notification', models.CharField(choices=[('ON', 'ON'), ('OFF', 'OFF')], default='ON', max_length=3)),
                ('toggle_privacy', models.CharField(choices=[('ON', 'ON'), ('OFF', 'OFF')], default='OFF', max_length=3)),
                ('toggle_email', models.CharField(choices=[('ON', 'ON'), ('OFF', 'OFF')], default='ON', max_length=3)),
            ...
            managers=[
                ('objects', expenditure.models.user.UserManager()),
            ],
        ),
        migrations.CreateModel(
            name='IncomeCategory',
