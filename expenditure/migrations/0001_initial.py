# Generated by Django 4.1.5 on 2023-02-18 10:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_limit_type', models.CharField(choices=[('weekly', 'Weekly'), ('monthly', 'Monthly'), ('yearly', 'Yearly')], default='weekly', max_length=7)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('limit', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='expenditure.limit')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('spending_category', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='transactions', to='expenditure.spendingcategory')),
            ],
            options={
                'ordering': ['-date'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(blank=True)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('income_category', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='transactions', to='expenditure.incomecategory')),
            ],
            options={
                'ordering': ['-date'],
            },
