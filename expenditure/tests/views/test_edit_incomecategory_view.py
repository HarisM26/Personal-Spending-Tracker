...
class EditIncomeCategoryViewTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.url_edit_category = reverse('edit_income_category', kwargs={'pk': self.category.id})
    ...
    def test_edit_category_url(self):
        ...
        self.assertEqual(self.url_edit_category, f"/income-category/{self.category.id}/edit")
