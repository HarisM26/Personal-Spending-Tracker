...
class TransactionViews(TestCase):
    ...
    def setUp(self):
        ...
        self.url_edit_transaction = reverse('edit_spending', args=[self.transaction.id])
        self.url_edit_incoming_transaction = reverse('edit_income', args=[self.transaction_incoming.pk])
    ...
    def test_add_transaction(self):
        ...
        response_url = reverse('add_spending_transaction', args=[self.transaction.spending_category.pk])
    ...
    def test_add_incoming_transaction(self):
        ...
        response_url = response_url = reverse('add_income_transaction', args=[self.transaction_incoming.income_category.pk])
        self.assertRedirects(response, response_url, status_code=302, target_status_code=200)
